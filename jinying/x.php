<?php
	...
	$visitor= array('ip' => $_SERVER['REMOTE_ADDR'],'fromaddr' => $_SERVER['HTTP_REFERER'], 'time' => strtotime("now") );
...
<head>
    ...
    <meta name="description" content="专业课活动页面" />
    <meta name="keywords" content="专业课活动页面" />
...
<body>
	...
	<style>
		...
		.pointer {cursor:pointer;}
 		...
 		/* 12 */
 		#g12 {height:710px;width:1030px;margin:0 auto;}
 		#g121 {left:802px;top:8px;width:144px;height:52px;}
 		#g122 {left:708px;top:458px;width:224px;height:76px;}
 		#g12demo {left:70px;top:70px;width:890px;height:480px;overflow: hidden;}
 		#g12demonav {left:130px;top:550px;width:752px;height:160px;overflow:hidden;}
 		#g12demonavw {width:10000px;}
 		#g12demonav img {border:2px solid #666;margin:10px 7px;padding:0px;width:170px;}
 		#g12prev {left:84px;top:607px;width:40px;height:48px;}
 		#g12next {left:919px;top:607px;width:40px;height:48px;}
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F19acac896c10a53a535a8549a3df4010' type='text/javascript'%3E%3C/script%3E"));
</script>
</body>